...
<%
	...
	try {
		if (colId == null) colId = session.getAttribute("colId").toString();
	}
	catch (Exception e) {
                                ...
                                <div class="col-lg-12">
                                    <form name="dynamicForm" id="dynamicForm" role="form" method="post" action="jsoup/dynamicCheck.jsp">
										...
										<div class="form-group">
                                            ...
                                            <% session.removeAttribute("postid_input"); %>
                                            <input name="replacepostid_input" id="postidpattern_input" class="form-control" placeholder="Replace Post ID" <% if (replacepostid_input != null) { %> value="<% out.print(replacepostid_input); } %>">
...
<!--                                         <button type="button" class="btn btn-default" title="Add" onclick="add1()">Add New Field</button> -->
									                    ...
									                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
									                        <h4 class="modal-title" id="myModalLabel">Template list</h4>
									                            ...
									                            <div class="modal-footer">
																	...
																	<button type="submit" onclick="submitForm('api/getTemplate.jsp')" class="btn btn-default" data-dismiss="modal">Ok</button>
                                        ...
                                        <button type="button" onclick="submitForm('jsoup/dynamicCheck.jsp')" class="btn btn-default" title="Run Testing"><img src="images/run.png" width="15px" height="17px"></button>
										<button type="button" class="btn btn-default" style="float:right" type="button" class="btn btn-default" data-toggle="modal" data-target="#template">Use Template</button>
										<div class="row" style="margin:30px 10px 0px 0px">
											...
											<button type="submit" onclick="submitForm('create_crawler_general.jsp')"  class="btn btn-default" title="Next">Next</button>
											<button type="button" onclick="submitForm('api/createCrawler.jsp')" class="btn btn-default disabled" title="Finish">Finish</button>
